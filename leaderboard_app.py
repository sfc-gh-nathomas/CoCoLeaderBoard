...
_SE_ATTR_CTE = """se_attr AS (
    ...
    FROM SALES.SE_REPORTING.DIM_ACCOUNTS_SE_ATTRIBUTES_DAILY
...
def _setsail_ses_cte():
    ...
    FROM SALES.SE_REPORTING.DIM_ACCOUNTS_SE_ATTRIBUTES_DAILY se
    ...
    WHERE se.DS = (SELECT MAX(DS) FROM SALES.SE_REPORTING.DIM_ACCOUNTS_SE_ATTRIBUTES_DAILY)
